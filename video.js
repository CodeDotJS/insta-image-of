...
const argv = require('yargs')
	...
	.usage(colors.cyan.bold('\nUsage : $0 -u [full-link] -n [video-name]'))

	.demand(['u', 'n'])

	.describe('u', colors.cyan.bold('❱ ') + ' full link to download video')

	.describe('n', colors.cyan.bold('❱ ') + ' save video as              ')
